...
class Siswa extends Component {
    ...
    get_siswa = () => {
       $("#loading").toast("show") ;
       let url = "http://localhost/pelanggaran_siswa/public/siswa";
       axios.get(url)
       .then(response => {
    ...
    Drop = (id) => {
        if (window.confirm("Apakah anda yakin ingin menghapus data ini?")) {
            $("#loading").toast("show");
            let url = "http://localhost/pelanggaran_siswa/public/siswa/drop/" + id;
            axios.delete(url)
            .then(response => {
                $("#loading").toast("hide");
    ...
    Save = (event) => {
        ...
        $("#loading").toast("show");
        $("#modal_siswa").toast("hide");
        let url = "http://localhost/pelanggaran_siswa/punlic/siswa/save";
